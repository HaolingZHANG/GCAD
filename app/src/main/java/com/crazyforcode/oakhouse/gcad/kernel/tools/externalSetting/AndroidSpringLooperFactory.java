 ...
 *
 */
package com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting;
...
abstract class AndroidSpringLooperFactory {
  ...
  /**
   * Create an Android {@link com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.SpringLooper}
   * for the detected Android platform.
  ...
  /**
   * The base implementation of the Android spring looper,
   * using a {@link Handler} for the
   * frame callbacks.
   */
