...
import com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.SimpleSpringListener;
import com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.Spring;
import com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.SpringConfig;
import com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.SpringSystem;
import com.crazyforcode.oakhouse.gcad.kernel.tools.externalSetting.SpringUtil;
...
public class ToggleButton extends View{
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#02a8f3");
	/** 关闭颜色*/
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWidthForTB, borderWidth);
	...
	public void toggle(boolean animate) {
		...
		//TODO 在这里编辑监听
//		if(toggleOn) {
//			TextToast.showTextToast("您已开启外设", getContext());
//			MainActivity mainActivity = (MainActivity) MainActivity.staticActivity;
//			mainActivity.showAltitude();
//		} else {
//			TextToast.showTextToast("您已关闭外设", getContext());
//			MainActivity mainActivity = (MainActivity) MainActivity.staticActivity;
//			mainActivity.hideAltitude();
//		}
	}
